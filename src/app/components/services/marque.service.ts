...
export class MarqueService {
  ...
  createData(  file: File, file1 : File, nommarque: string, teleMarque: string, emailMarque: string  ): Observable<HttpEvent<any>>
{
  ...
  updateData( idmarque: string, file: File, file1 : File, nommarque: string, teleMarque: string,
